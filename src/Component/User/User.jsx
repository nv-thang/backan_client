...
export default function APIs() {
	...
	const fetchData = async () => {
		const url = `${process.env.REACT_APP_API_URL}/user/getAllUser`
		try {
	...
	const handleSaveUser = async () => {
		if (!id) {
			...
			const url = `${process.env.REACT_APP_API_URL}/user/updateUser?id=${id}`
			const user = {
				username: userName,
				password: password,
				firstname: firstName,
	...
	const handleDeleteUser = async (rowData) => {
		const url = `${process.env.REACT_APP_API_URL}/user/deleteUser?id=${rowData.id}`
	...
	const handleEditClick = async (rowData) => {
		...
		const url = `${process.env.REACT_APP_API_URL}/user/getUserById?id=${rowId}`
